...
const _props = defineProps({
  ...
  tags: { type: Array as () => Tag[], required: true },
  cta: { type: String, required: true },
  footerInfo: {
    type: Object as () => { usage: string, guarantee: string },
    required: true
  },
    ...
    <div class="container mx-auto px-4 max-w-7xl">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div class="w-full h-[500px] lg:h-[600px] rounded-2xl overflow-hidden shadow-lg">
          <img
            :src="coverImage"
            :alt="`Fachada do parceiro ${partnerName}`"
        ...
        <div class="flex flex-col justify-center">
          ...
          <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-blue-500 leading-tight mb-6">
